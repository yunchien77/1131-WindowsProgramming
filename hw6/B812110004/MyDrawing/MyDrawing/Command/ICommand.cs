...
namespace MyDrawing.Command
{
    ...
    public class DrawShapeCommand : ICommand
    {
        ...
        public void Undo()
        {
            ...
            Console.WriteLine($"Undoing shape with details:");
            Console.WriteLine($"ID: {_shape.Id}");
            Console.WriteLine($"Type: {_shape.GetShapeType()}");
            Console.WriteLine($"Text: {_shape.Text}");
            Console.WriteLine($"Position: X={_shape.PositionX}, Y={_shape.PositionY}");
            Console.WriteLine($"Size: Width={_shape.Width}, Height={_shape.Height}");
    ...
    public class ModifyTextCommand : ICommand
    {
        ...
        public ModifyTextCommand(Shape shape, string oldText, string newText)
        {
            _shape = shape;
            _oldText = oldText;
            _newText = newText;
    ...
    public class MoveTextCommand : ICommand
    {
        ...
        public MoveTextCommand(IShape shape,
            float oldTextX, float oldTextY,
            float newTextX, float newTextY)
        {
            _shape = shape;
