...
namespace MyDrawing.Shapes
{
    ...
    public class StartShape : Shape
    {
        public override void Draw(IGraphics graphics)
        {
            ...
            //Console.WriteLine($"{GetShapeType()} Shape Details:");
            //Console.WriteLine($"Shape Position: X={PositionX}, Y={PositionY}");
            //Console.WriteLine($"Text Position: X={TextPositionX}, Y={TextPositionY}");
        }
        ...
        private void UpdateOrangeDotPosition()
        {
            ...
            //Console.WriteLine($"------ initail dot position: {OrangeDotPosition.X}, {OrangeDotPosition.Y}");
        }
    }
