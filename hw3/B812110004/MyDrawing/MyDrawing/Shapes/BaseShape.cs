...
namespace MyDrawing.Shapes
{
    ...
    public class TerminatorShape : Shape
    {
        ...
        {
            //// 繪製左半圓
            //graphics.DrawArc(PositionX, PositionY, Height, Height, 90, 180);

            //// 繪製右半圓
            //graphics.DrawArc(PositionX + Width - Height, PositionY, Height, Height, 270, 180);

            //// 繪製上方連接線
            //graphics.DrawLine(PositionX + Height / 2, PositionY, PositionX + Width - Height / 2, PositionY);

            //// 繪製下方連接線
            //graphics.DrawLine(PositionX + Height / 2, PositionY + Height, PositionX + Width - Height / 2, PositionY + Height);
