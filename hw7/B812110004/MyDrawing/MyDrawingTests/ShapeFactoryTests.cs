...
namespace MyDrawing.Tests
{
    ...
    public class ShapeFactoryTests
    {
        ...
        public void CreateShape_ValidShapeTypes_ShouldCreateCorrectShapes()
        {
            ...
            Assert.IsInstanceOfType(ShapeFactory.CreateShape("Line"), typeof(LineShape));
        }
    ...
    public class ShapeTests
    {
        ...
        [TestMethod]
        public void LineShape_Draw_ShouldCallDrawLine()
        {
            // Arrange
            var mockGraphics = new MockGraphics();
            ...
            // Initialize presenter with mocked parameters
            var mockPresenter = new MyDrawingPresenter(mockModel, mockAction);
            line.SetPresenter(mockPresenter);

            // Act
            line.Draw(mockGraphics);

            // Assert
            Assert.AreEqual(1, mockGraphics.DrawLineCallCount);
        }

        [TestMethod]
        public void LineShape_GetShapeType_ShouldReturnLine()
        {
            // Arrange
            var line = new LineShape();

            // Act
            var shapeType = line.GetShapeType();

            // Assert
            Assert.AreEqual("Line", shapeType);
        }
    }
    ...
    public class MockGraphicsTests
    {
        ...
        public void DrawTextBorder_ShouldIncrementCallCount()
        {
            ...
            // Act
            mockGraphics.DrawTextBorder("Test", 0, 0);
