...
namespace MyDrawing.Tests
{
    ...
    [TestClass]
    public class PresenterSavingTests
    {
        private MockMyDrawingModel _mockModel;
        private MyDrawingPresenter _presenter;
        private Form _mockForm;
        ...
        //[TestMethod]
        //public async Task SaveShapesAsync_ShouldSetIsSavingFlagCorrectly()
        //{
        //    // Arrange
        //    bool isSavingDuringOperation = false;
        //    bool propertyChangedRaised = false;
        //    _presenter.PropertyChanged += (s, e) =>
        //    {
        ...
        //    // Act
        //    var saveTask = _presenter.SaveShapesAsync("test.mydrawing");
        //    isSavingDuringOperation = (bool)typeof(MyDrawingPresenter)
        //        .GetProperty("IsSaving", BindingFlags.Public | BindingFlags.Instance)
        //        .GetValue(_presenter);
        //    await saveTask;

        //    // Assert
        //    Assert.IsTrue(propertyChangedRaised, "PropertyChanged should be raised for IsSaving");
        //    Assert.IsTrue(isSavingDuringOperation, "IsSaving should be true during save operation");
        //    Assert.IsFalse((bool)typeof(MyDrawingPresenter)
        //        .GetProperty("IsSaving", BindingFlags.Public | BindingFlags.Instance)
        //        .GetValue(_presenter), "IsSaving should be false after save operation");
        //}

        //[TestMethod]
        //public void LoadShapes_ShouldCreateAndExecuteLoadCommand()
        //{
        //    // Arrange
        //    var wasCommandExecuted = false;
        //    var testCommandManager = new TestCommandManager();
        //    typeof(MyDrawingPresenter)
        //        .GetField("_commandManager", BindingFlags.NonPublic | BindingFlags.Instance)
        //        .SetValue(_presenter, testCommandManager);

        //    testCommandManager.ExecuteCallback = (command) =>
        //    {
        //        wasCommandExecuted = command is LoadCommand;
        //    };

        //    // Act
        //    _presenter.LoadShapes("test.mydrawing");

        //    // Assert
        //    Assert.IsTrue(wasCommandExecuted, "LoadCommand should be executed");
        //}

        //[TestMethod]
        //public async Task AutoSaveTimer_Elapsed_ShouldHandleAutoSaveCorrectly()
        //{
        //    // Arrange
        //    bool isAutoSavingDuringOperation = false;
        //    bool propertyChangedRaised = false;
        //    _mockModel.HasUnsavedChanges = true;
        ...
        //    // Act
        //    var timerField = typeof(MyDrawingPresenter).GetField("_autoSaveTimer",
        //        BindingFlags.NonPublic | BindingFlags.Instance);
        //    var timer = (System.Timers.Timer)timerField.GetValue(_presenter);
        //    timer.Elapsed += async (s, e) =>
        //    {
        //        isAutoSavingDuringOperation = (bool)typeof(MyDrawingPresenter)
        //            .GetProperty("IsAutoSaving", BindingFlags.Public | BindingFlags.Instance)
        //            .GetValue(_presenter);
        //    };
        //    timer.Start();

        //    // Wait for timer to elapse
        //    await Task.Delay(31000); // Slightly longer than AutoSaveInterval

        //    // Assert
        //    Assert.IsTrue(propertyChangedRaised, "PropertyChanged should be raised for IsAutoSaving");
        //    Assert.IsFalse((bool)typeof(MyDrawingPresenter)
        //        .GetProperty("IsAutoSaving", BindingFlags.Public | BindingFlags.Instance)
        //        .GetValue(_presenter), "IsAutoSaving should be false after operation");
        //}

        //[TestMethod]
        //public void CleanupOldBackups_ShouldDeleteExcessBackupFiles()
        //{
        //    // Arrange
        //    string testDir = Path.Combine(Path.GetTempPath(), "test_backups");
        ...
        //    {
        //        File.WriteAllText(
        //            Path.Combine(testDir, $"2024010{i}120000_bak.mydrawing"),
        //            "test content"
        //        );
        //    }

        //    // Act
        //    var method = typeof(MyDrawingPresenter).GetMethod("CleanupOldBackups",
        //        BindingFlags.NonPublic | BindingFlags.Instance);
        //    method.Invoke(_presenter, new object[] { testDir });

        //    // Assert
        //    int remainingFiles = Directory.GetFiles(testDir, "*_bak.mydrawing").Length;
        //    Assert.AreEqual(5, remainingFiles, "Should keep only 5 most recent backup files");
        ...
        //[TestMethod]
        //public void CleanupOldBackups_ShouldHandleDeleteErrors()
        //{
        //    // Arrange
        //    string testDir = Path.Combine(Path.GetTempPath(), "test_backups");
        //    Directory.CreateDirectory(testDir);
        ...
        //    using (var stream = File.OpenWrite(Path.Combine(testDir, "20240100120000_bak.mydrawing")))
        //    {
        ...
        //[TestMethod]
        //public void OnPropertyChanged_ShouldHandleInvokeRequired()
        //{
        //    // Arrange
        //    bool propertyChangedRaised = false;
        //    _presenter.PropertyChanged += (s, e) => propertyChangedRaised = true;

        //    // Create a separate thread to simulate UI thread requirement
        //    Thread thread = new Thread(() =>
        //    {
        //        // Act
        //        var method = typeof(MyDrawingPresenter).GetMethod("OnPropertyChanged",
        //            BindingFlags.NonPublic | BindingFlags.Instance);
        //        method.Invoke(_presenter, new object[] { "TestProperty" });
        //    });
        ...
        //[TestMethod]
        //public void OnPropertyChanged_ShouldHandleDisposedView()
        //{
        //    // Arrange
        //    bool propertyChangedRaised = false;
        //    _presenter.PropertyChanged += (s, e) => propertyChangedRaised = true;
        ...
        //    // Assert
        //    Assert.IsTrue(propertyChangedRaised, "PropertyChanged event should be raised even with disposed view");
        //}

        [TestMethod]
        public void RestorePresenterReferences_ShouldSetPresenterForAllShapes()
        {
            // Arrange
            var mockShape1 = new MockShape();
            var mockShape2 = new MockShape();
            _mockModel.Shapes.Add(mockShape1);
            _mockModel.Shapes.Add(mockShape2);

            // Act
            _presenter.RestorePresenterReferences();

            // Assert
            Assert.AreEqual(_presenter, mockShape1.Presenter, "First shape should have presenter reference");
            Assert.AreEqual(_presenter, mockShape2.Presenter, "Second shape should have presenter reference");
        }

        // Helper class for testing command execution
        public class TestCommandManager : CommandManager
        {
            public Action<ICommand> ExecuteCallback { get; set; }

            public void Execute(ICommand command)
            {
                ExecuteCallback?.Invoke(command);
            }
        }
    }
}